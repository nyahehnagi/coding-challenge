...
class ProcessorUpgrade(val jlpLaptop : IJLPLaptop):  IJLPLaptop by jlpLaptop {
...
class MemoryUpgrade(val jlpLaptop : IJLPLaptop): IJLPLaptop by jlpLaptop {
...
class BatteryUpgrade(val jlpLaptop : IJLPLaptop): IJLPLaptop by jlpLaptop {
...
class HardDriveUpgrade(val jlpLaptop : IJLPLaptop): IJLPLaptop by jlpLaptop {
...
class GraphicsUpgrade(val jlpLaptop : IJLPLaptop): IJLPLaptop by jlpLaptop {
...
class ShinyCaseUpgrade(val jlpLaptop : IJLPLaptop): IJLPLaptop by jlpLaptop {
